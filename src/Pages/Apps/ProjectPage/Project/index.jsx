...
import {
  ...
  developmentProjects,
  projectData,
} from "@/Data/Projectapp/ProjectAppData";
...
const Projects = () => {
  ...
  return (
    <Container fluid>
      <Row className=" m-1">
        <Col xs={12}>
          <h4 className="main-title">Brands</h4>
            ...
            <ul className="tabs">
              ...
              <li className="ms-auto">
                <div className="text-end">
                  <Button
                    color="primary"
                    className="mb-3 w-45 h-45 icon-btn b-r-10 m-2"
                    onClick={toggleModal}
                  >
                    ...
                    <div className="card hover-effect project-app-card">
                      <div className="card-header">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 ps-2">
                            ...
                            <div className="text-muted f-s-14">
                              {project.subTitle}
                            </div>
                          </div>
                      ...
                      <CardBody>
                        ...
                        <div className="text-end mb-2">
                          <span
                            className={`badge text-light-${project.status.toLowerCase()}`}
                          >
                            {project.status}
                          </span>
                        </div>
