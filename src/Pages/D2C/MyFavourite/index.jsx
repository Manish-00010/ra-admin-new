...
const D2CMyFavourite = () => {
  const navigate = useNavigate();
  const [layout, setLayout] = useState("col-xl-4 col-md-6 col-12 col-exl-3 ");
    ...
    filtered.sort((a, b) => {
      switch (selectedSortBy) {
        ...
        case "Highest Commission":
          return b.price * 0.12 - a.price * 0.12;
        case "Newest":
          return (
  ...
  return (
    <div className="d2c-favourite-products">
      <style>{`
        /* Date picker styles */
