    ...
    (function(factory) {
      ...
      (function($2) {
        ...
        $2.vakata.context = {
          ...
          _execute: function(i) {
            ...
            return i && (!i._disabled || $2.vakata.is_function(i._disabled) && !i._disabled({ "item": i, "reference": vakata_context.reference, "element": vakata_context.element })) && i.action ? i.action.call(null, {
              "item": i,
              "reference": vakata_context.reference,
              "element": vakata_context.element,
              "position": {
          ...
          _parse: function(o, is_callback) {
            ...
            $2.each(o, function(i, val) {
              ...
              sep = false;
              str += "<li class='" + (val._class || "") + (val._disabled === true || $2.vakata.is_function(val._disabled) && val._disabled({ "item": val, "reference": vakata_context.reference, "element": vakata_context.element }) ? " vakata-contextmenu-disabled " : "") + "' " + (val.shortcut ? " data-shortcut='" + val.shortcut + "' " : "") + ">";
              ...
              str += ($2.vakata.is_function(val.label) ? val.label({ "item": i, "reference": vakata_context.reference, "element": vakata_context.element }) : val.label) + (val.shortcut ? ' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-' + val.shortcut + '">' + (val.shortcut_label || "") + "</span>" : "") + "</a>";
              if (val.submenu) {
          ...
          show: function(reference, position, data) {
            ...
            if (vakata_context.items.length) {
              ...
              vakata_context.element.css({ "left": x, "top": y }).show().find("a").first().trigger("focus").parent().addClass("vakata-context-hover");
          ...
          vakata_context.element.on("mouseenter", "li", function(e) {
            ...
            if ($2.vakata.context.settings.hide_onmouseleave) {
              to2 = setTimeout(
                ...
                $2.vakata.context.settings.hide_onmouseleave
              );
            }
      ...
      $.jstree.plugins.state = function(options, parent) {
        ...
        this.save_state = function() {
          ...
          var st = { "state": tm, "ttl": this.settings.state.ttl, "sec": +/* @__PURE__ */ new Date() };
      ...
      $.jstree.plugins.types = function(options, parent) {
        ...
        this.get_json = function(obj, options2, flat) {
          var i, j, m = this._model.data, opt = options2 ? $.extend(true, {}, options2, { no_id: false }) : {}, tmp = parent.get_json.call(this, obj, opt, flat);
          if (tmp === false) {
            return false;
          }
